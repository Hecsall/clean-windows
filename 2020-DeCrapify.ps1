...
Write-Host "Disabling Let Windows track app launches..."
...
Write-Host "Disabling Let websites provide locally relevant content..."
...
Set-ItemProperty -Path "HKLM:\SOFTWARE\Wow6432Node\Policies\Microsoft\Windows\WindowsUpdate\AU" "ScheduledInstallTime" 12
